...
- **Backend Languages**: Go (ConnectRPC), TypeScript (Hono)
- **Web Framework**: React 19 (Next.JS/Tanstack Start)
...
├── /docs          # Documentation (pure markdown)
...
- Bash/Python for scripting (use Bun TypeScript)
...
2. **Deploy sub-agents with Task tool** to analyze:
   ...
   ```
3. Implement feature following discovered patterns
